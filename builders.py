...
def build_maintenant_sport(root, filtre: str = None) -> list:
...
def build_nouveautes_tnt(root, day_offset: int):
...
def build_prime_results(root, day_offset: int, ch_set: set = None):
...
def build_nuit_results(root, day_offset: int, ch_list: list = None):
